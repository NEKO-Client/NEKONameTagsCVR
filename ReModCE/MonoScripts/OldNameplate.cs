...
using static NEKOClient.AssetManager;
using System;
...
namespace NEKOClient.MonoScripts
{
    public class OldNameplate : MonoBehaviour
    {
        ...
        public void Awake()
        {
            ...
            if (player == null)
            {
                NEKOClient.NameplateManager.RemoveNameplate(descriptor.ownerId);
                Destroy(Nameplate);
                return;
            }
        ...
        */
        ...
        public void ApplySettings()
        {
            try
            {
                ...
                {
                    NEKOClient.Error("[0006] Player is null, cannot apply settings.");
                }
            }
            catch (Exception e)
            {
                NEKOClient.Error("[0003] Unable to Apply Nameplate Settings:\n" + e);
            }
        }
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        NEKOClient.DebugError("Invalid color string for name color.");
                    }
                }
            }
        }
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        NEKOClient.DebugError("Invalid color string for nameplate color.");
                    }
                }
            }
        }
        ...
        public void OnOffsetUpdate()
        {
            ...
            {
                NEKOClient.Error("PuppetMaster is null, cannot apply offset.");
            }
        }
        ...
        public void OnModernMovementToggle()
        {
            ...
            {
                _constraint = Nameplate!.AddComponent<PositionConstraint>();
                NEKOClient.Error("[0000] Constraint is null, forcefully adding it.");
            }

            if (_constraint.sourceCount > 1)
            {
                NEKOClient.Error("[0001] Constraint.sourceCount is greater than 1, resetting...");
            ...
            if (_constraint.sourceCount == 1)
            {
                ...
                {
                    NEKOClient.Debug("[0002] Removing Null Constraint Source");
