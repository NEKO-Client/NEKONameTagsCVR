...
namespace NEKONameTagsCVR
{
    public class Main : MelonMod
    {
        ...
        private static void ShowLogo()
        {
            ...
            Console.WriteLine("                                                                                                              ");
            Console.WriteLine(@"                       NEKONameTagsCVR is Nametag MOD (OLD VRC MOD)- By ChisVR, Bison, Aries                 ");
            Console.WriteLine(@"=============================================================================================================");
        ...
        private static void GeneratePlate(string uid, string plateText, int multiplier,Color32 color)
        {
            ...
            try
            {
                ...
                s_MainPlateHolder = GameObject.Instantiate(s_namePlate, GameObject.Find("/" + uid + "[NamePlate]/Canvas").transform);
                s_MainPlateHolder.transform.localPosition = new Vector3(0, 0.755f - (multiplier) * 0.0978f, 0);
                ...
                GameObject.Destroy(s_MainPlateHolder.transform.Find("Image/ObjectMaskSlave").gameObject);
                GameObject.Destroy(s_MainPlateHolder.transform.Find("Disable with Menu").gameObject);
                s_MainPlateHolder.transform.localScale = new Vector3(0.3f, 0.5f, 1);
                ...
                s_textMeshProGmj.transform.localScale = new Vector3(0.01f, 0.01f, 1);
                s_textMeshProGmj.transform.localPosition = new Vector3(0, 0.02f, 0);
